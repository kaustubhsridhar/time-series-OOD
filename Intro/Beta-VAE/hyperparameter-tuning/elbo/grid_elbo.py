...
def hyperparameter_search(combinations_list,inp,train_data,call1):
        ...
        for combination in combinations_list:
            ...
            #csv_path,size = latent_generator(encoder,train_data,dir_path)
            #MIG = MIG_calculation(csv_path,nl,size)
...
if __name__ == '__main__':
    ...
    betas = [1.0,1.1]#hyperparameter2
    combinations_list = [list(x) for x in product(Latents,betas)]
    print("******************************Hyperparameter Tuning******************************************")
    parameter, best_parameter,scores,latent_inputs,beta_inputs = hyperparameter_search(combinations_list,inp,train_data,call1)
