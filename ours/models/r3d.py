...
class Regressor(nn.Module):
    def __init__(self, indim=1024, num_classes=4): #indim = [orig_img_avg_pooled_features, trans_img_avg_pooled_features], num_classes is the number of possible transformations = 4}
        super(Regressor, self).__init__()

        fc1_outdim = 256

        self.r3d = R3DNet(layer_sizes=(1,1,1,1), with_classifier=False)
