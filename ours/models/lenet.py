...
class LeNet5(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.layer6 =  nn.Sequential(
            nn.Flatten(),
            nn.Linear(in_features=1440, out_features=84), # 1440 for cl 18/20, 1080 for cl 16
            nn.Tanh())
...
class Regressor(nn.Module):
    def __init__(self, indim=168, num_classes=4): #indim = [orig_img_avg_pooled_features, trans_img_avg_pooled_features] = 2*enc_dim from forward, num_classes is the number of possible transformations = 4}
        ...
        self.lenet = LeNet5(n_classes = self.num_classes)
