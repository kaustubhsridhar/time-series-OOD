...
## Step 2: Download data from https://drive.google.com/drive/folders/1Z-3YnlhcCxI_KlFF6FF7tMp5MSEZURRH?usp=sharing
    mkdir data
    cd data
...
## Step 4: Check OOD with $wl$=16/18/20, $disease_type$=als/park/hunt/all
    mkdir gait_log
