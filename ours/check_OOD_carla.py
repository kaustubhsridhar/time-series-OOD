...
if __name__ == "__main__":
    ...
    print("Avg. Det Delay on CARLA dataset for {} as OOD type and n=20: {}".format(opt.save_dir[-5:],det_delay) # detection delay in seconds - 16/20 is the time duration for 1 window
