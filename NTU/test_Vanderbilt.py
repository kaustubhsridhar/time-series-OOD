...
bi3dof_simple_test_in = {
    "model_file" : "Vanderbilt_models/bi3dof-simple-600epoch-6seq.pt", # "model/nuscenes-mini/bi3dof-simple-600epoch.pt",
    "network" : "simple",   
    "test_clips": "../Vanderbilt_features_all/in.test", # "data/nuscenes-v1.0-mini.test",      
    "frames_per_clip": frame_lens['in']
}

def getOutBi3DOF(type_of_OOD):
	features_folder = "../Vanderbilt_features_all/" 
...
def run(type_of_OOD):
	...
	try:
		os.mkdir('./plots_Vanderbilt/')
	except:
		pass
	plt.savefig('./plots_Vanderbilt/plot_{}.png'.format(type_of_OOD))
