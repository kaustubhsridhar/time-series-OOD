...
def run():
	...
	# save 
	try:
		os.mkdir("carla_models")
	except:
		pass

	torch.save(vae.state_dict(), "carla_models/bi3dof-{}-{}epoch-{}seq.pt".format(args.latentprior,  epoch+1, args.n_seqs[0]) )
...
args = init_param()
args.training = True
args.data_file = "../carla_features_all/train.train" # "data/nuscenes-v1.0-mini.train"
run()
